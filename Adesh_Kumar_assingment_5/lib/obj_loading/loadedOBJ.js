...
class LoadedOBJ extends Geometry {
  ...
  // updateAnimation(){
	...
	// tempMatrix.rotate(this.currentAngle, 0, 1, 0);
  ...
  render(){
    ...
    {
      useShader(gl, objProgram);
      sendOBJBufferToGLSL(this.vertices, 3, "a_Position");
      sendOBJBufferToGLSL(this.vertices, 3, "a_Color");
    ...
    else
    {
      ...
      sendOBJBufferToGLSL(this.vertices, 3, "a_Position");
      console.log('99')
      sendTextureBufferToGLSL(this.vertices, 2, "aTextureCoord"); 
      console.log('2')
      create2DTexture(texture, gl.LINEAR, gl.LINEAR, gl.REPEAT, gl.REPEAT, 
        function (texture) {
          console.log('4')
