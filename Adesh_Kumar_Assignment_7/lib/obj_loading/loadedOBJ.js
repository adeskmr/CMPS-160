...
class LoadedOBJ extends Geometry {
   ...
   */
  constructor(objStr, xVal, yVal, zVal, redColor, greenColor, blueColor, alpaColor) {
    super();
   ...
   // console.log(objStr);
    ...
    for (var i = 0; i < objMesh.indices.length; i++) {
      ...
      this.vertices[i].color.push(redColor, greenColor, blueColor, alpaColor);
    }
    ...
    this.moveOBJToCenterOfScreen(transAndScaleVal[0], xVal, yVal, zVal);
   ...
   * axis (indices: 0, 1, 2)
   */
  moveOBJToCenterOfScreen(transValue, xVal, yVal, zVal) {
    this.modelMatrix.setTranslate(transValue[0] + xVal, yVal, transValue[2] + zVal);
